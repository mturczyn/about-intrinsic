    ...
    pl: {
        translation: {
            ...
            homePageIntroduction: {
                ...
                thirdPara: `Mój pierwszy język programowania, który nauczyłem się, to C# wraz z frameworkiem WinForms. Przez lata miałem okazję pracować z wieloma frameworkami .NET, takimi jak ASP.NET, WPF, Blazor. Nauczyłem się również JS (HTML, CSS, JS) i frameworka React.`,
            },
